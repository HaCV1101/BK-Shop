...
public class PasswordField extends JPasswordField {
    ...
    public PasswordField() {
        ...
        eye = new ImageIcon(Objects.requireNonNull(getClass().getResource("eye.png"))).getImage();
        eye_hide = new ImageIcon(
            Objects.requireNonNull(getClass().getResource("eye_hide.png"))).getImage();
